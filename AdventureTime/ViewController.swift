...
class ViewController: UIViewController {
    ...
    func createAllCharacters() {
        ...
        jake = Character(name: "Jake The Dog", species: "Dog", occupation: "Sidekick", powerLevel: 30.0)
        bubblegum = Character(name: "Princess Bubblegum", species: "Human", occupation: "Candy", powerLevel: 30.0)
        bmo = Character(name: "BMO", species: "What", occupation: "Living", powerLevel: 20.0)
        lemongrab = Character(name: "Lemongrab", species: "Lemon Life", occupation: "Out Chea", powerLevel: 15.0)
        lsp = Character(name: "Lumpy Space Princess", species: "WTF", occupation: "Lumpy", powerLevel: 100.0)
    }
